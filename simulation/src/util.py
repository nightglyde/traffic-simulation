...
VIRTUAL_TRAFFIC_LIGHTS_2_MODE = 2
MY_TRAFFIC_CONTROLLER_MODE    = 3
GREEDY_CONTROLLER_MODE        = 4

ALL_STRATEGIES = [
    (TRAFFIC_LIGHTS_MODE,           "TrafficLights"),
    (VIRTUAL_TRAFFIC_LIGHTS_MODE,   "VirtualTrafficLights"),
    (VIRTUAL_TRAFFIC_LIGHTS_2_MODE, "VirtualTrafficLights2"),
    (MY_TRAFFIC_CONTROLLER_MODE,    "MyTrafficController"),
    (GREEDY_CONTROLLER_MODE,        "GreedyController"),
]

VTL_MODES = {VIRTUAL_TRAFFIC_LIGHTS_MODE, VIRTUAL_TRAFFIC_LIGHTS_2_MODE}

MTC_MODES = {MY_TRAFFIC_CONTROLLER_MODE, GREEDY_CONTROLLER_MODE}
...
VTL_FOLLOW_DIST_2 = MIN_DIST_APART + 10
