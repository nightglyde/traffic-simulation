...
Label(fullSimFrame, text="GUI Not Implemented for \"Run Simulation with Results\"").pack()
...
Label(analyseFrame, text="GUI Not Implemented for \"Analyse Simulation Results\"").pack()
